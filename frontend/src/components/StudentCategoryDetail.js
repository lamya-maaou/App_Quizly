  ...
  const removeQuestion = async (index) => {
    ...
    try {
      ...
      if (questionToRemove.id) {
        await axios.delete(
          `http://localhost:8000/api/student/questions/${questionToRemove.id}/delete/`,
          {
            headers: {
              Authorization: `Bearer ${localStorage.getItem("token")}`,
            },
  ...
  const saveQuiz = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `http://localhost:8000/api/student/quizzes/${generatedQuiz.id}/update/`,
        quizData,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
      ...
      const updatedQuiz = await axios.get(
        `http://localhost:8000/api/student/quizzes/${generatedQuiz.id}/`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
          },
